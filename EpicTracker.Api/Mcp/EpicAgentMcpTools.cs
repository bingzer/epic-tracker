...
[McpServerToolType]
public class EpicAgentMcpTools(EpicService service)
{
    ...
    public Task<Epic> Advance(
        ...
        CancellationToken cancellationToken = default)
        => service.Advance(epicId, new AdvanceEpicRequest(epicAgentId), cancellationToken);
    ...
    public Task RaiseAgentSwarm(
        ...
        CancellationToken cancellationToken = default)
        => service.RaiseAgentSwarm(epicId, new RaiseAgentSwarmRequest(objective, toStateName), cancellationToken);
    ...
    public Task SubmitAgreement(
        ...
        CancellationToken cancellationToken = default)
        => service.SubmitAgreement(epicId, new SubmitAgreementRequest(agentId, hasAgreed, note), cancellationToken);
    ...
    public Task RaiseHumanInLoop(
        ...
        CancellationToken cancellationToken = default)
        => service.RaiseHumanInLoop(epicId, new RaiseHumanInLoopRequest(questions, approveToStateName, rejectToStateName), cancellationToken);
    ...
    public Task<Spec> CreateSpec(
        ...
        CancellationToken cancellationToken = default)
        => service.CreateSpec(epicId, new CreateSpecRequest(assignedAgentId, specDocPath, codeReviewRequired, reviewerAgentId), cancellationToken);
    ...
    public Task<Spec> AdvanceSpec(
        [Description("The ID of the spec to advance.")] string specId,
        CancellationToken cancellationToken = default)
        => service.AdvanceSpec(specId, cancellationToken);
    ...
    public Task<Epic> UpdateEpic(
        ...
        CancellationToken cancellationToken = default)
        => service.UpdateEpicField(epicId, fieldName, value, cancellationToken);
    ...
    public Task<Spec> UpdateSpec(
        [Description("The ID of the spec to update.")] string specId,
        [Description("The name of the field to set.")] string fieldName,
        [Description("The string value to set. Booleans should be 'true' or 'false'.")] string value,
        CancellationToken cancellationToken = default)
        => service.UpdateSpecField(specId, fieldName, value, cancellationToken);
