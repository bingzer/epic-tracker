const stateColors: Record<string, string> = {
  ...
  human_in_loop:      'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300',
  implementation:     'bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300',
  ...
  coding:             'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300',
  ...
  spec_human_in_loop: 'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-300',
